...
**The Single Accent technique:** grade the world naturally, and let **one colour be the only vivid thing in frame** — and in a story, make that colour belong to the thing the story is about.
> *"the RED of her headwrap the only saturated thing in a blue-grey dawn"*
Used on a recurring character or a story element, it lets the audience track them across a cut without a single word. (In the ad swarm this technique carries a brand colour; here there is no brand, so it carries meaning instead.)
