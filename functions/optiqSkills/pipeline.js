...
11. SILENT FOOTAGE, VISUAL DIALOGUE — the generated clip carries NO audio whatsoever; the ad's music and narration are composed separately in post. So the film MUST read with the sound OFF. People may talk, gesture and converse naturally, but any words the viewer needs to understand appear VISUALLY — on-screen kinetic captions, title cards, or chat-bubble pop-ups over the speaker's head, ad-style — NEVER as audible speech that must be heard. Carry the whole story through action, expression, product, environment and on-screen text. Never depend on dialogue the audience cannot hear.`;
