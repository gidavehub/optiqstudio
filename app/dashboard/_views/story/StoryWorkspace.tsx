...
// StoryWorkspace — /dashboard/project/story/[id].
//
// The experimental original story's own workspace, and a DELIBERATE DUPLICATE of
// ProjectWorkspace rather than a branch inside it. Same reasoning as the four
// storyboard sandboxes in functions/: this is not the same product, and a single
// screen serving both meant every tweak to either had to be checked against the
// other.
//
...
// the same fix — they are allowed to diverge, and they will.
